...
- **CI**: Advanced the `github/codeql-action/init` and `.../analyze` pinned SHA from `7188fc3` (v4.37.1) to `e4fba86` (v4.37.3) in `codeql.yml` via the workflow-dependencies group (Dependabot PR #92) to clear the Pin Drift gate; no user-facing CodeQL changes upstream
